...
-- Вместо записи 'INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY'  можно написать 'SERIAL PRIMARY KEY'
-- Добавить перед созданием таблицы DROP TABLE IF EXISTS и DROP DATABASE IF EXISTS(удалить таблицу и базу, если она уже есть). Позволит многократно запускать файл и не заботиться
-- о том, существовала ли таблица до этого
